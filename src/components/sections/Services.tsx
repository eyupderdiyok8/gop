...
const services = [
  {
    ...
    desc: "Ev, ofis ve iş yerlerine uygun ters ozmoz (RO), tezgâh altı, tezgâh üstü ve inline filtrasyon sistemleri.",
    items: ["Ev tipi RO sistemleri", "Ofis tipi damacana alternatifi", "Tezgâh üstü kompakt modeller", "Endüstriyel çözümler"],
    href: "/urunler",
    cta: "Ürünleri İncele",
    accent: "teal",
  },
  ...
  },
  {
    ...
    title: "Arıza Servisi",
    desc: "Sultangazi ve İstanbul Avrupa Yakası'nda arıza tespiti, parça kontrolü ve yerinde teknik servis.",
    items: ["Uygunluğa göre aynı gün planlama", "Modele uygun yedek parça", "İşlem öncesi bilgilendirme", "Şeffaf fiyatlandırma"],
